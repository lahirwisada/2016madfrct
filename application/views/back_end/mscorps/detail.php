        ...
        <form enctype="multipart/form-data" method="POST" class="form-horizontal">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 col-xs-12 control-label">Inisial corps *</label>
                        <div class="col-md-6 col-xs-12">                                            
                            <div class="input-group">
                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                <input type="text" name="init_corps" class="form-control" value="<?php echo $detail ? $detail->init_corps : ""; ?>">
                            </div>                                            
                            <span class="help-block">Isikan sesuai dengan inisial corps</span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 col-xs-12 control-label">Uraian corps *</label>
                        <div class="col-md-6 col-xs-12">                                            
                            <div class="input-group">
                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                <input type="text" name="ur_corps" class="form-control" value="<?php echo $detail ? $detail->ur_corps : ""; ?>">
                            </div>                                            
                            <span class="help-block">Isikan sesuai dengan uraian corps</span>
                        </div>
                    </div>
                </div>
