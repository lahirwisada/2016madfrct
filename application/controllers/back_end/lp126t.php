...
class Lp126t extends Back_end {

    public $model = 'model_tr_formulir';

    public function __construct() {
        parent::__construct('modul_laporan', 'Laporan 126 T');
        $this->load->model('model_tr_126t_detail');
    }
    ...
    public function detail($id_formulir = FALSE) {
        $records = $this->model_tr_126t_detail->get_data($id_formulir);
