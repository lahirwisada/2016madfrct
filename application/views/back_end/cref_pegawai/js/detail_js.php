...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#frm-ref-pegawai").submit(function (e) {
            e.preventDefault();

            var data = formDetailPegawai.collectData();

            $.ajax({
                url: "<?php echo base_url('back_end/cref_pegawai/detail'); ?>",
                data: data,
                method: 'POST',
                success: function (response, textStatus) {
                    window.location.href = "<?php echo base_url("back_end/cref_pegawai/index"); ?>";
                },
                complete: function () {
