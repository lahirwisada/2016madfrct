...
//var_dump($records["tingkat"]["PATI"]);exit;
?>
<div class="row">
    <div class="col-md-12">
            ...
            <div class="panel panel-default tabs">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <?php foreach ($records["tingkat"] as $tingkat => $data) : ?>
                        <li><a href="#tab-<?php echo strtolower($tingkat); ?>" role="tab" data-toggle="tab"><?php echo strtoupper($tingkat); ?></a></li>
                    <?php endforeach; ?>
                </ul>
                ...
                <div class="panel-body tab-content">
                    <div class="tab-pane active" id="tab-rekap">
                        <div class="block">
                            ...
                            <a class="btn btn-primary" href="<?php echo base_url() ?>back_end/lpkotama/export/rekap/<?php echo $bulan.'/'.$tahun;?>"><i class="fa fa-print"></i> Export </a>
                        </div>
                        <div class="block">
                                    ...
                                    <table class="table no-footer table-bordered table-condensed table-striped" id="DataTables_Table_0">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="text-center" rowspan="2">KOTAMA/BALAKPUS</th>
                    ...
                    <!--Rekapitulasi Berdasarkan Tingkat-->

                    <?php if ($records["tingkat"]): ?>
                        <?php foreach ($records["tingkat"] as $tingkat => $data) : ?>
                            <?php
                            $next_list_number = 1;
