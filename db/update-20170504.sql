...
<tr><th>Username<td><input name="auth[username]" id="username" value="postgres" autocapitalize="off">
<tr><th>Password<td><input type="password" name="auth[password]">
<tr><th>Database<td><input name="auth[db]" value="db_fcstprsn" autocapitalize="off">
</table>
<script type="text/javascript">
...
<input type='hidden' name='token' value='1016593:273835'>
</div>
</form>
<div id="menu">
<h1>
