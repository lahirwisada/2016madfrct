    ...
    function export($tipe = 'rekap', $bulan = 1, $tahun = 2014) {
        ...
        if ($records != FALSE) {
            ...
            foreach ($records['rekap'] as $key => $record):
                ...
                $objPHPExcel->getActiveSheet()->setCellValue('C' . $cell, $sub_dalam_top);
                $objPHPExcel->getActiveSheet()->setCellValue('D' . $cell, $sub_dalam_nyata);
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('C' . $cell, $total_dalam_top);
