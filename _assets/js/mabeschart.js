(function () {
    ...
    MabesChart.prototype.render = function () {
        ...
        if (data.max === 0) {
            this._container.innerHTML = "Belum ada data...";
        } else {
...
//        console.log(scale);
                ...
                drawText(context, data.struktur + " STRUKTUR TNI AD BULAN " + data.triwulan + " TAHUN " + data.tahun, "black", "center", tengahGambar, titleTop + scale20);
                // bayangan segitiga
                ...
                for (i = 0; i < jumlahPangkat; i++) {
                    ...
                    if (i > 9) {
                        drawText(context, Number(data.pangkat[i].nyata).toLocaleString('id'), "black", "right", tengahGambar + jmlNyata - scale10, garisTop + i * jarak + scale25);
                        drawText(context, Number(data.pangkat[i].top).toLocaleString('id'), "white", "left", tengahGambar - jmlTop + scale10, garisTop + i * jarak + tebalBar + scale25);
                    } else {
                        drawText(context, Number(data.pangkat[i].nyata).toLocaleString('id'), "black", "left", tengahGambar + jmlNyata + 5 * scale, garisTop + i * jarak + scale25);
                        drawText(context, Number(data.pangkat[i].top).toLocaleString('id'), "white", "right", tengahGambar - jmlTop - 5 * scale, garisTop + i * jarak + tebalBar + scale25);
                    }
                ...
                // text pati
                setFont(context, "Agency FB", scale20);
                drawText(context, data.tingkat[0].label + " (" + Number(data.tingkat[0].top).toLocaleString('id') + ")", "black", "center", tengahGambar - 200 * scale, garisTop + 4 * jarak - 30);
                drawText(context, data.tingkat[0].label + " (" + Number(data.tingkat[0].nyata).toLocaleString('id') + ")", "black", "center", tengahGambar + 200 * scale, garisTop + 4 * jarak - 30);
                // text pamen
                drawText(context, data.tingkat[1].label + " (" + Number(data.tingkat[1].top).toLocaleString('id') + ")", "black", "right", tengahGambar - 200 * scale, garisTop + 7 * jarak - 30);
                drawText(context, data.tingkat[1].label + " (" + Number(data.tingkat[1].nyata).toLocaleString('id') + ")", "black", "left", tengahGambar + 200 * scale, garisTop + 7 * jarak - 30);
                // text pama
                drawText(context, data.tingkat[2].label + " (" + Number(data.tingkat[2].top).toLocaleString('id') + ")", "black", "right", tengahGambar - 140 * scale, garisTop + 9 * jarak - 30);
                drawText(context, data.tingkat[2].label + " (" + Number(data.tingkat[2].nyata).toLocaleString('id') + ")", "black", "left", tengahGambar + 140 * scale, garisTop + 9 * jarak - 30);
                // text perwira
                drawText(context, data.golongan[0].label, "black", "right", tengahGambar - 310 * scale, garisTop + tebalBar);
                drawText(context, "(" + Number(data.golongan[0].top).toLocaleString('id') + ")", "black", "right", tengahGambar - 310 * scale, garisTop + tebalBar + scale20);
                drawText(context, data.golongan[0].label, "black", "left", tengahGambar + 310 * scale, garisTop + tebalBar);
                drawText(context, "(" + Number(data.golongan[0].nyata).toLocaleString('id') + ")", "black", "left", tengahGambar + 310 * scale, garisTop + tebalBar + scale20);
                // text bintara
                drawText(context, data.golongan[1].label, "black", "right", tengahGambar - 310 * scale, garisTop + 9 * jarak + tebalBar);
                drawText(context, "(" + Number(data.golongan[1].top).toLocaleString('id') + ")", "black", "right", tengahGambar - 310 * scale, garisTop + 9 * jarak + tebalBar + scale20);
                drawText(context, data.golongan[1].label, "black", "left", tengahGambar + 310 * scale, garisTop + 9 * jarak + tebalBar);
                drawText(context, "(" + Number(data.golongan[1].nyata).toLocaleString('id') + ")", "black", "left", tengahGambar + 310 * scale, garisTop + 9 * jarak + tebalBar + scale20);
                // text tamtama
                drawText(context, data.golongan[2].label, "black", "right", tengahGambar - 310 * scale, garisTop + 12 * jarak + tebalBar);
                drawText(context, "(" + Number(data.golongan[2].top).toLocaleString('id') + ")", "black", "right", tengahGambar - 310 * scale, garisTop + 12 * jarak + tebalBar + scale20);
                drawText(context, data.golongan[2].label, "black", "left", tengahGambar + 310 * scale, garisTop + 12 * jarak + tebalBar);
                drawText(context, "(" + Number(data.golongan[2].nyata).toLocaleString('id') + ")", "black", "left", tengahGambar + 310 * scale, garisTop + 12 * jarak + tebalBar + scale20);
            }

            // Note
            drawText(context, "1.  " + NiceText(data.tingkat[0].label) + " (" + Number(data.tingkat[0].nyata).toLocaleString('id') + " = " + (data.tingkat[0].top > 0 ? data.tingkat[0].nyata / data.tingkat[0].top * 100 : 0).toLocaleString('id') + " %)", "black", "left", 10, garisTop + jumlahPangkat * jarak + 100 * scale);
            drawText(context, "2.  " + NiceText(data.tingkat[1].label) + " (" + Number(data.tingkat[1].nyata).toLocaleString('id') + " = " + (data.tingkat[1].top > 0 ? data.tingkat[1].nyata / data.tingkat[1].top * 100 : 0).toLocaleString('id') + " %)", "black", "left", 10, garisTop + jumlahPangkat * jarak + 120 * scale);
            drawText(context, "3.  " + NiceText(data.tingkat[2].label) + " (" + Number(data.tingkat[2].nyata).toLocaleString('id') + " = " + (data.tingkat[2].top > 0 ? data.tingkat[2].nyata / data.tingkat[2].top * 100 : 0).toLocaleString('id') + " %)", "black", "left", 10, garisTop + jumlahPangkat * jarak + 140 * scale);
            drawText(context, "4.  " + NiceText(data.golongan[1].label) + " (" + Number(data.golongan[1].nyata).toLocaleString('id') + " = " + (data.golongan[1].top > 0 ? data.golongan[1].nyata / data.golongan[1].top * 100 : 0).toLocaleString('id') + " %)", "black", "left", 10, garisTop + jumlahPangkat * jarak + 160 * scale);
            drawText(context, "5.  " + NiceText(data.golongan[2].label) + " (" + Number(data.golongan[2].nyata).toLocaleString('id') + " = " + (data.golongan[2].top > 0 ? data.golongan[2].nyata / data.golongan[2].top * 100 : 0).toLocaleString('id') + " %)", "black", "left", 10, garisTop + jumlahPangkat * jarak + 180 * scale);
