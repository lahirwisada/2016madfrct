                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-xs-12">                                            
                            ...
                            <span class="help-block">Pilih Provinsi</span>
                        </div>
                    </div>
                <div class="panel-body">
                    <div class="form-group">
                        <label class="col-md-3 col-xs-12 control-label">Kode Kabupaten Kota *</label>
                        <div class="col-md-6 col-xs-12">                                            
                            <div class="input-group">
                                <input type="text" name="kode_kabupaten" class="form-control" value="<?php echo $detail ? $detail->kode_kabupaten : ""; ?>">
                            </div>                                            
                    ...
                    <div class="form-group">
                        <label class="col-md-3 col-xs-12 control-label">Nama Kabupaten Kota *</label>
                        <div class="col-md-6 col-xs-12">                                            
                            <div class="input-group">
                                <input type="text" name="nama_kabupaten" class="form-control" value="<?php echo $detail ? $detail->nama_kabupaten : ""; ?>">
                            </div>                                            
                            <span class="help-block">Isikan sesuai dengan nama kabupaten kota yang tertera pada Ketetapan Kementerian Dalam Negeri tentang Wilayah Indonesia.</span>
                        </div>
                    </div>
                </div>
